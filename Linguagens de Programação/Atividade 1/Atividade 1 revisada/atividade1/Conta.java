...
public class Conta {
    ...
    public void mostrarTudo(){
        this.titular.mostrar(); // mostrarTudo não deveria mostrar o saldo e o limite junto? Parece desnecessario ja que possui outros metodos de ewxibição embaixo
    }
    ...
    public void depositar(double valor){
        ...
        if(valor>0){
            ...
            if(this.dinheiro.getMoeda() == 'e'){
                this.dinheiro.setSaldo(this.dinheiro.realParaEuro(saldo1)); // não existe realParaEuro
            }
    ...
    public void transferirPara(Conta conta2, double valor){
        if(this.sacar(valor)){
            this.depositar(valor); // deposito não deveria ser para conta2?
        }
        else{
